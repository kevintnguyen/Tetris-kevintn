...
public final class Board extends Observable {
    ...
    /**
     * moveleft() finds out if a piece can moveleft at it's given position.
     *  @author Kevin Nguyen
     * @version 4.5.0 December 2015
     * @return a boolean determining whether it can move left in given position.
     */
    ...
    /**
     * addPropertyListener() adds scoretimes as a property change listner.
     *  @author Kevin Nguyen
     * @version 4.5.0 December 2015
     * @param theScoreTimes is added to PropertyChangeListener list.
     */
    public void addPropertyListener(final ScoreTimes theScoreTimes) {
        myPC.addPropertyChangeListener(theScoreTimes);
    }
    ...
    /**
     * gamerOverNow() sets the game to gamer over.
     *  @author Kevin Nguyen
     * @version 4.5.0 December 2015
     */
    public void gamerOverNow() {
        myGameOver = true;
    }
    ...
    /**
     * moveright() finds out if a piece can moveright at it's given position.
     *  @author Kevin Nguyen
     * @version 4.5.0 December 2015
     * @return a boolean determining whether it can move right in given position.
     */
    ...
    /**
     * rotate2() finds out if a piece can rotate at it's given position.
     *  @author Kevin Nguyen
     * @version 4.5.0 December 2015
     * @return a boolean determining whether it can rotate left or right in given position.
     */
     ...
     */
    private void freeze() {
        //added by Kevin Nguyen.
        final SoundPlayer local = new SoundPlayer();
        local.play("sounds/D.wav");
    ...
    private void clearLines() {
        for (int i = myFrozenBlocks.size() - 1; i >= 0; i--) {
            ...
            if (clear) {
                ...
                setChanged();
                notifyObservers();
                myPC.firePropertyChange("Score", 0, TWOSEVENFIVE);
            }
        }
    }
