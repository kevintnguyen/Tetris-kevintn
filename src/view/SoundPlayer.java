...
public class SoundPlayer {
    ...
    /**
     * mySongPlaying is a boolean that determines whether the main song is playing.
     *  @author Kevin Nguyen
     * @version 4.5.0 December 2015
     */
    private boolean mySongPlaying;
    ...
    public Clip play(final String theFilename) throws IllegalArgumentException {
        mySongPlaying = true; //Kevin Nguyen
    ...
    public void pause(final String theFilename) throws IllegalArgumentException {
        final Clip clip = getClip(theFilename);
        mySongPlaying = false; //Kevin Nguyen
        if (clip != null) {
     ...
     * @author Kevin Nguyen
     * @version 4.5.0 December 2015
     * getplaying() returns a boolean determining whether the main song is playing or not.
     * @return mySongPlaying returns true if the song is playing, else false.
     */
    public boolean isSongPlaying() {
        return mySongPlaying; //Kevin Nguyen
    }
    /** 
